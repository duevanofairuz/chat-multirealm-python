...
if __name__=="__main__":
    ...
    while True:
        ...
        6. Mengirim pesan ke group: sendgroup [nama_group] [message]\n
        7. Melihat pesan: inbox\n
        8. Logout: logout\n
        9. Melihat user yang aktif: info\n

        Command MultiRealm Server:\n\n
        10. Menambah realm: addrealm [nama_realm] [address] [port]\n
        11. Mengirim pesan ke realm: sendprivaterealm [name_realm] [username to] [message]\n
        12. Mengirim pesan ke group realm: sendgrouprealm [name_realm] [usernames to]/[group:][group_name] [message]\n
        13. Melihat pesan realm: getrealminbox [nama_realm]\n
        """)
